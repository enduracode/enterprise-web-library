...
namespace RedStapler.StandardLibrary.EnterpriseWebFramework {
	...
	public abstract class EwfPage: Page {
		...
		private void addJavaScriptIncludes() {
			...
			ClientScript.RegisterClientScriptInclude( GetType(), "jQuery UI", this.GetClientUrl( "~/Ewf/JQueryUi/js/jquery-ui-1.9.0.custom.min.js" ) );
			ClientScript.RegisterClientScriptInclude( GetType(), "Select2", this.GetClientUrl( "~/Ewf/Select2-3.3.1/select2.min.js" ) );
