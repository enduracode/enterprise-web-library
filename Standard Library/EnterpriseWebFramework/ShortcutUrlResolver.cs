...
namespace RedStapler.StandardLibrary.EnterpriseWebFramework {
	...
	public class ShortcutUrlResolver {
		...
		/// handle requests for the application root, specify the empty string. The specified function will be called when a request for the shortcut URL comes in
		/// and should return the page you want to display. The page may vary depending on the authenticated user, and returning null will display the Access Denied
		/// page. Do not return a page that the authenticated user cannot access.
		/// </summary>
