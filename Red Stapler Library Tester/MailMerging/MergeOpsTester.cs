...
using RedStapler.StandardLibraryTester.MailMerging.MergeFields.PhysicianMergeFields;
using RedStapler.StandardLibraryTester.MailMerging.MergeFields.PracticeDocumentMergeFields;
using RedStapler.StandardLibraryTester.MailMerging.MergeFields.TestFileMergeFields;
using Email = RedStapler.StandardLibraryTester.MailMerging.MergeFields.PracticeManagerMergeFields.Email;

namespace RedStapler.StandardLibraryTester.MailMerging {
	[ TestFixture ]
