...
public static class RandomStatics {
	...
	private static Random random => randomPerThread ??= new Random();
	...
	/// </summary>
	public static T? GetRandomElement<T>( this IEnumerable<T> enumeration ) => enumeration.ElementAtOrDefault( GetRandomInt( 0, enumeration.Count() ) );
