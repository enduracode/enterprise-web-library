...
namespace EnterpriseWebLibrary.MultiColumnForms {
	...
	public class MultiColumnValidator<TColumnMod> {
		private readonly TColumnMod[] mods;
		...
		/// </summary>
		public void ValidateRow<TColumnField>(
			TColumnField[] fields, CellValidationMethod<TColumnMod, TColumnField> cellValidationMethod, CheckBox fieldValuesDifferent ) {
