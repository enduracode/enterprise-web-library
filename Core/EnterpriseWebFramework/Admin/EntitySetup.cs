...
partial class EntitySetup: UiEntitySetup {
	...
	protected override IEnumerable<UrlPattern> getChildUrlPatterns() =>
		StaticFiles.FolderSetup.UrlPatterns.Literal( "static" )
			...
			.Append( EnterpriseWebFramework.UserManagement.Pages.ExternalLogIn.UrlPatterns.Literal( "external-log-in" ) )
			.Append( EnterpriseWebFramework.UserManagement.Pages.AuthenticateWithExternalCode.UrlPatterns.Literal( "authenticate-with-code" ) )
			.Append( EnterpriseWebFramework.UserManagement.SamlResources.Metadata.UrlPatterns.Literal( "saml" ) )
			.Append( EnterpriseWebFramework.UserManagement.Pages.VerifyClientFunctionality.UrlPatterns.Literal( "verify-functionality" ) )
