...
public class PageReloadBehavior {
	...
	/// Creates a behavior.
	/// </summary>
	/// <param name="focusKey">The focus key, which you can use to autofocus on a region of the reloaded page by referencing the key from autofocus conditions. Do
	/// not pass null. Pass the empty string for no autofocus.</param>
