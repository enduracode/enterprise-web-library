...
public class FlowCheckbox: FormControl<FlowComponent> {
	private static readonly ElementClass unhighlightedClass = new( "ewfFcu" );
	private static readonly ElementClass highlightedClass = new( "ewfFch" );
	private static readonly ElementClass nestedContentClass = new( "ewfFcc" );
	...
	public FlowCheckbox(
		...
		var checkbox = new Checkbox( value, label, setup: checkboxSetup, validationMethod: validationMethod );
