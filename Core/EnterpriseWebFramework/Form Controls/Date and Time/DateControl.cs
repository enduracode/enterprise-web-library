...
namespace EnterpriseWebLibrary.EnterpriseWebFramework {
	...
	public class DateControl: FormControl<PhrasingComponent> {
		private static readonly ElementClass elementClass = new ElementClass( "ewfDc" );
		...
		public DateControl(
			...
			setup = setup ?? DateControlSetup.Create();
						...
						children: textControl.PageComponent.ToCollection()
							.Concat(
								setup.IsReadOnly
									...
									: new EwfButton(
										new CustomButtonStyle( children: new FontAwesomeIcon( "fa-calendar" ).ToCollection() ),
