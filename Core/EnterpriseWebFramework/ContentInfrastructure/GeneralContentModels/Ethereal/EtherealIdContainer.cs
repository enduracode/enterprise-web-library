...
namespace EnterpriseWebLibrary.EnterpriseWebFramework.ContentInfrastructure.GeneralContentModels.Ethereal;
...
public class EtherealIdContainer: EtherealComponent {
	...
	public EtherealIdContainer( IEnumerable<EtherealComponent> children, UpdateRegionSetsParameter? updateRegionSets = null ) {
		identifiedComponent = new IdentifiedEtherealComponent( () => new IdentifiedComponentData<EtherealComponentOrElement>(
			"",
