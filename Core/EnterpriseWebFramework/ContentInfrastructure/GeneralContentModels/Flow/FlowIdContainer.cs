namespace EnterpriseWebLibrary.EnterpriseWebFramework.ContentInfrastructure.GeneralContentModels.Flow;
...
public class FlowIdContainer: FlowComponent {
	...
	public FlowIdContainer( IEnumerable<FlowComponent> children, UpdateRegionSetsParameter? updateRegionSets = null ) {
		identifiedComponent = new IdentifiedFlowComponent( () => new IdentifiedComponentData<FlowComponentOrNode>(
			"",
