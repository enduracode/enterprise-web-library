...
public sealed class Section: FlowComponent {
	...
	private static readonly ElementClass allStylesBothStatesClass = new( "ewfSec" );

	private static readonly ElementClass normalClosedClass = new( "ewfSecNorClosed" );
	private static readonly ElementClass normalExpandedClass = new( "ewfSecNorExpanded" );
	private static readonly ElementClass boxClosedClass = new( "ewfSecBoxClosed" );
	private static readonly ElementClass boxExpandedClass = new( "ewfSecBoxExpanded" );
	private static readonly ElementClass headingClass = new( "ewfSecHeading" );
	private static readonly ElementClass closeClass = new( "ewfSecClose" );
	private static readonly ElementClass expandClass = new( "ewfSecExpand" );
	private static readonly ElementClass contentClass = new( "ewfSecContent" );
		...
		children = new DisplayableElement( context => {
			...
			FlowComponent getHeadingButton() {
				var headingComponents =
					new DisplayableElement( headingContext => new DisplayableElementData(
						null,
