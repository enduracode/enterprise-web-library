...
internal static class TableCellVerticalAlignmentOps {
	...
	private static readonly ElementClass topCssClass = new( "ewfTcTop" );
	private static readonly ElementClass middleCssClass = new( "ewfTcMiddle" );
	private static readonly ElementClass bottomCssClass = new( "ewfTcBottom" );
	private static readonly ElementClass baseLineCssClass = new( "ewfTcBaseLine" );
