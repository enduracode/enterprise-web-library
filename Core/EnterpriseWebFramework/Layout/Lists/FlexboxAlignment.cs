...
internal static class FlexboxAlignmentStatics {
	...
	private static readonly ElementClass leftClass = new( "ewfFaL" );
	private static readonly ElementClass rightClass = new( "ewfFaR" );
	private static readonly ElementClass centerClass = new( "ewfFaC" );
	private static readonly ElementClass justifyClass = new( "ewfFaJ" );
