...
internal static class FlexboxVerticalAlignmentStatics {
	...
	private static readonly ElementClass topClass = new( "ewfFvaT" );
	private static readonly ElementClass bottomClass = new( "ewfFvaB" );
	private static readonly ElementClass centerClass = new( "ewfFvaC" );
	private static readonly ElementClass baselineClass = new( "ewfFvaBl" );
