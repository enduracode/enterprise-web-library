...
internal static class GridAlignmentStatics {
	...
	private static readonly ElementClass leftClass = new( "ewfGaL" );
	private static readonly ElementClass rightClass = new( "ewfGaR" );
	private static readonly ElementClass centerClass = new( "ewfGaC" );
	private static readonly ElementClass stretchClass = new( "ewfGaS" );
