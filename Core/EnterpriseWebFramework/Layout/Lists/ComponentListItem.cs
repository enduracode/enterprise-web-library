...
public class ComponentListItem {
	...
	internal readonly UpdateRegionSetsParameter? RemovalUpdateRegionSets;

	internal ComponentListItem(
		Func<bool, ElementClassSet, CssLength?, FlowComponentOrNode> componentGetter, string id, UpdateRegionSetsParameter? removalUpdateRegionSets ) {
		this.componentGetter = componentGetter;
		Id = id;
		RemovalUpdateRegionSets = removalUpdateRegionSets;
	}

	internal Tuple<ComponentListItem, FlowComponentOrNode>
		GetItemAndComponent( ElementClassSet classes, CssLength? width, bool includeContentContainer = false ) =>
		Tuple.Create( this, componentGetter( includeContentContainer, classes, width ) );
}
...
public static class ComponentListItemExtensionCreators {
	...
	public static ComponentListItem ToComponentListItem(
		...
		UpdateRegionSetsParameter? updateRegionSets = null, IReadOnlyCollection<EtherealComponent>? etherealContent = null ) =>
	...
	internal static ComponentListItem ToComponentListItem(
		...
		UpdateRegionSetsParameter? updateRegionSets, IReadOnlyCollection<EtherealComponent>? etherealContent,
	...
	public static ComponentListItem ToComponentListItem(
		...
		UpdateRegionSetsParameter? updateRegionSets = null, UpdateRegionSetsParameter? removalUpdateRegionSets = null,
	...
	internal static ComponentListItem ToComponentListItem(
		...
		UpdateRegionSetsParameter? updateRegionSets, UpdateRegionSetsParameter? removalUpdateRegionSets, IReadOnlyCollection<EtherealComponent>? etherealContent,
		Func<ElementContext, string, IReadOnlyCollection<ElementAttribute>?, DisplayableElementLocalData>? localDataGetter ) {
