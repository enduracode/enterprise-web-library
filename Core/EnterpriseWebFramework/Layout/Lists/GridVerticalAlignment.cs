...
internal static class GridVerticalAlignmentStatics {
	...
	private static readonly ElementClass topClass = new( "ewfGvaT" );
	private static readonly ElementClass bottomClass = new( "ewfGvaB" );
	private static readonly ElementClass centerClass = new( "ewfGvaC" );
	private static readonly ElementClass stretchClass = new( "ewfGvaS" );
