...
internal static class TextAlignmentStatics {
	...
	private static readonly ElementClass leftCssClass = new( "ewfTaL" );
	private static readonly ElementClass rightCssClass = new( "ewfTaR" );
	private static readonly ElementClass centerCssClass = new( "ewfTaC" );
	private static readonly ElementClass justifyCssClass = new( "ewfTaJ" );
