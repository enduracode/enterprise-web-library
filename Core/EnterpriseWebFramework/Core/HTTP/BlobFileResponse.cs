...
public class BlobFileResponse {
	...
	/// <param name="processAsAttachmentGetter">A function that gets whether you want the response to be processed as an attachment. Return true if you want this
	/// behavior; otherwise return false or do not pass a function.</param>
	...
	internal Instant FileLastModificationTime => file.UploadTime;
