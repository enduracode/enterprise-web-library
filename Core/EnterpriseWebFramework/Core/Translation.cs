...
internal static class Translation {
	...
	internal static TrustedHtmlString AnotherUserHasModifiedPageAndWeCouldNotInterpretAction =>
		new(
			getCorrectTranslation(
	...
	internal static TrustedHtmlString YouHaveModifiedPageAndWeCouldNotInterpretAction =>
		new(
			getCorrectTranslation(
