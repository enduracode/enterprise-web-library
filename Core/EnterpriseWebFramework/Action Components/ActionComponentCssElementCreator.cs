...
public class ActionComponentCssElementCreator: ControlCssElementCreator {
	...
	internal static readonly ElementClass AllStylesClass = new( "ewfAction" );

	internal static readonly ElementClass HyperlinkStandardStyleClass = new( "ewfActionText" );
	internal static readonly ElementClass ShrinkWrapButtonStyleClass = new( "ewfActionShrinkWrapButton" );
	internal static readonly ElementClass NormalButtonStyleClass = new( "ewfActionNormalButton" );
	internal static readonly ElementClass LargeButtonStyleClass = new( "ewfActionLargeButton" );
	internal static readonly ElementClass ImageStyleClass = new( "ewfActionImage" );

	internal static readonly ElementClass NewContentClass = new( "ewfNc" );
