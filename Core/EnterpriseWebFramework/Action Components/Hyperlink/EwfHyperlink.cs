...
public sealed class EwfHyperlink: PhrasingComponent {
	...
	/// JavaScript action statements to any behavior, we recommend using the DOMContentLoaded event to add a click handler to the appropriate a element(s), which
	/// you can select using a class if there is no simpler way.</param>
