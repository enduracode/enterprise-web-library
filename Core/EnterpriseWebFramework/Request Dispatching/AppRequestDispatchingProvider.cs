...
public abstract class AppRequestDispatchingProvider {
	...
	/// <summary>
	/// Returns the custom well-known URLs for the application; see RFC 8615. Do not return null.
	/// </summary>
	protected internal virtual IEnumerable<WellKnownUrl> GetWellKnownUrls() => Enumerable.Empty<WellKnownUrl>();
