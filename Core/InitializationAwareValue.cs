...
public class InitializationAwareValue<T>: IEquatable<InitializationAwareValue<T>> {
	...
	public override bool Equals( object? obj ) => Equals( obj as InitializationAwareValue<T> );

	public bool Equals( InitializationAwareValue<T>? other ) => other != null && Initialized && other.Initialized && EwlStatics.AreEqual( value, other.value );
