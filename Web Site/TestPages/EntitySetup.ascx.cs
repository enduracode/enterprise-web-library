...
namespace EnterpriseWebLibrary.WebSite.TestPages {
	public partial class EntitySetup: UserControl, EntityDisplaySetup {
				...
				return new List<PageGroup>
					{
						...
						new PageGroup( "Form Controls", new CheckBox.Info( this ), new CheckBoxList.Info( this ) )
					};
			}
		...
		public List<LookupBoxSetup> CreateLookupBoxSetups() {
			...
			lookupBoxSetups.Add( new LookupBoxSetup( 100, "Lookup!", ( cn, text ) => { throw new EwfException( "Lookup '" + text + "' failed." ); } ) );
